...
function TermAndPrivacy() {
  return (
    <>
      <a
        className="text"
        href="https://yoctol.ai/terms-of-use"
        target="_blank"
      ...
      <a
        className="text"
        href="https://yoctol.ai/privacy-policy"
        target="_blank"
        rel="noopener noreferrer"
        style={{ marginLeft: 16 }}
      >
...
class Footer extends React.Component {
  ...
  render() {
    const { baseUrl, copyright } = this.props.config;
        ...
        <div className="footer-layout">
          <div>
            <div style={{ marginBottom: 16 }}>
              <a
                href="https://yoctol.ai"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
                  width="104px"
                  src={`${baseUrl}img/element_YOCTOL.AI_horizontal_S.svg`}
                  alt="YOCTOL.AI Logo"
                />
              </a>
            </div>
          ...
          <div className="footer-medias">
            ...
            <div className="icons">
              ...
              <a
                href="https://www.linkedin.com/company/yoctol/"
                target="_blank"
                rel="noopener noreferrer"
                style={{ marginLeft: 8 }}
              >
